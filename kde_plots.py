...
ax.axvline( 67.4, lw=1, label='Planck', color='blue') #67.4 +-0.5 from 2018 https://arxiv.org/abs/1807.06209 
ax.axvline( 67.4, lw=2, alpha=0.4, color='blue') #67.4 +-0.5 from 2018 https://arxiv.org/abs/1807.06209 
ax.axvspan( 72.04, 74.06, label='SH0ES', color='skyblue') #https://arxiv.org/abs/2112.04510 73.04+-1.04
ax.axvspan( 71.04, 75.1,  alpha=0.4, color='skyblue') #https://arxiv.org/pdf/2112.04510.pdf 

H0=np.linspace(20,200, 10**3)
ax.plot(H0, kernel(H0), linewidth=1, label='GW170817', color='orchid')
...
ax.plot(H0, kernel(H0), linewidth=1, label='GW190521 + GW170817', color='purple')
...
ax.plot(H0, kernel(H0), linewidth=1, label='GW190521', color='magenta')
