...
ax.axvspan( 66.4, 68.4, alpha=0.6, label='Planck', color='skyblue' ) #67.4 +-0.5 from 2018 https://arxiv.org/abs/1807.06209 
ax.axvline( 65.4, 69.4, alpha=0.5, color='skyblue') #67.4 +-0.5 from 2018 https://arxiv.org/abs/1807.06209 
...
ax.plot(H0, kernel(H0), linewidth=1, ls='-.', c='orangered', label='GW170817')
...
ax.plot(H0, kernel(H0), linewidth=1, c='indigo', label='GW190521 + GW170817')
...
ax.plot(H0, kernel(H0), linewidth=1, ls='--', c='seagreen', label='GW190521')
